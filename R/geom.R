...
#'
#' @description A geom that plots a timeline of earthquakes in one line
#'   optionally grouped by country, colored by number of casualties and size by
#'   scale.
#'
